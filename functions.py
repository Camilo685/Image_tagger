...
image_organizer_script_name = "Image_organizer.py"
functions_script = "functions.py"
main_script = "main.py"

to_retrieve = [[0, display_icon_list], [1, program_folder], [2, icons_folder], [3, image_organizer_script_name], [4, functions_script], [5, main_script]]
